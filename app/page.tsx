  ...
  return (
    <main>
      ...
      <section className="hero shell" id="top">
        <div className="eyebrow"><span></span>2025–2026 台灣軟體職缺匿名資料</div>
      ...
      <footer><div className="shell footer-grid">
        ...
        <div className="footer-links"><span>DATA</span><a href="https://docs.google.com/spreadsheets/d/1GMYKVBxRlMv6oNVNzpXYoLUSyT8ZnLEjGcRbn0b4KsA/edit?gid=788239997#gid=788239997" target="_blank" rel="noreferrer">DCard 科技業版<br />軟體工程師調查表 ↗</a><a href="https://docs.google.com/spreadsheets/d/134kDFDnJIBFJLr1HEHktWnlZ015ATELy8YwahHE3ZDo/edit?usp=sharing" target="_blank" rel="noreferrer">自行調查匿名表單 ↗</a></div>
